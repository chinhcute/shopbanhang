         ...
         <div class="container">
             <div class="row justify-content-center mt-5">
               <div class="col-lg-4 col-md-6 col-sm-8">
                 <h2 class="text-center mb-4">Mật khẩu mới</h2>
                 <form action="${action}" method="POST">
                   <div class="mb-3">
                     <label for="input" class="form-label">Mật khẩu mới</label>
                     <input type="password" name="input1" class="form-control" id="input" placeholder="Nhập mật khẩu mới">
                    ...
                    <div class="mb-3">
                     <label for="input" class="form-label">Nhập lại mật khẩu mới</label>
                     <input type="password" name="input2" class="form-control" id="input" placeholder="Nhập lại mật khẩu mới">
                       <div style = "color: red;" role="alert" >
                            ${error}
                        </div>
                   </div>
