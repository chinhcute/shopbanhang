     ...
     $(document).ready(function () {
      ...
      <c:if test="${success_product == true }">
         ...
         $(document).ready(function () {
          ...
          <c:if test="${add_product == true }">
                    <div class="modal fade" id="add_product" tabindex="-1" role="dialog" aria-labelledby="notEnoughQuantityModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: rgb(48, 147, 5); color: aliceblue;">
                                    <h5 class="modal-title" id="notEnoughQuantityModalLabel">Thông báo</h5>
                                ...
                                <div class="modal-footer">
                                    <button type="button" id = "close_add_product" class="btn btn-secondary" style="background-color: rgb(48, 147, 5); color: aliceblue;" data-dismiss="modal">Đóng</button>
                                </div>
                            </div>
                        </div>
                    </div>
