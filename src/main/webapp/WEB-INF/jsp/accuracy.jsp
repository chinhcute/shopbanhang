             ...
             <div class="row justify-content-center mt-5">
               <div class="col-lg-4 col-md-6 col-sm-8">
                 ...
                 <form action="${accuracy}" method="POST">
                   <div class="mb-3">
                     <label for="input" class="form-label">Xác thực</label>
                     <input type="number" name="input" class="form-control" id="input" placeholder="Nhập mã xác thực">
                      <small class="form-text text-muted"><errors name="input" class="text-danger" /></small>
                   </div>
